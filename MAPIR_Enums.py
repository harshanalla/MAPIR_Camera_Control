...
class eRegister(IntEnum):
    ...
    # RG_MAVLINK_TYPE = 82
    # RG_MAVLINK_UDP_LISTEN_PORT = 83
    # RG_MAVLINK_SERIAL_PORT_IDX = 84
    # RG_MAVLINK_SERIAL_PORT_BAUD = 85
    # RG_MAVLINK_SERIAL_PORT_RTSCTS = 86
    # INTERNAL
    RG_UNIQUE_ID = 82
    RG_UNIQUE_ID_2 = 83
    RG_UNIQUE_ID_3 = 84
    ...
    # RG_MAVLINK_TYPE = 93
    # RG_MAVLINK_UDP_LISTEN_PORT = 94
    # RG_MAVLINK_SERIAL_PORT_IDX = 95
    # RG_MAVLINK_SERIAL_PORT_BAUD = 96
    # RG_MAVLINK_SERIAL_PORT_RTSCTS = 97
    # ACTIVE
